...
export default function Sidebar({ collapsed = false, onToggle, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Modal xác nhận đăng xuất - được làm đẹp */}
      {showLogoutConfirm && (
        <div
          style={{
            position: "fixed",
            ...
            >
              ...
              >
                <MessageSquare
                  size={18}
                  style={{
                    color: activeId === conv.id ? "var(--brand)" : "var(--text-muted)",
                    transition: `color ${T}`,
                  }}
                />
              </div>
        ...
        >
          ...
          {isUserMenuOpen && (
            <div
              style={{
                ...
                left: collapsed ? "calc(100% + 12px)" : 14,
            ...
            >
              {isLoggedIn || currentUser ? (
                <>
                  ...
                  <div
                    style={{ height: 1, background: "var(--border)", margin: "4px 0", opacity: 0.6 }}
                  />
                  <div
                    onClick={() => {
                      setIsUserMenuOpen(false);
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 14,
              border: isUserMenuOpen ? "1px solid var(--border)" : "1px solid transparent",
              background: isUserMenuOpen ? "var(--bg-2)" : "transparent",
              transition: "all 0.2s",
            }}
